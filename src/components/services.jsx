  ...
  return (
    <main className="w-full overflow-hidden">
      ...
      {/* =========================
          PAGE HEADER
      ========================= */}
      <section className="w-full bg-white py-10 sm:py-14 lg:py-16 rounded-lg">
        ...
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {services.map((service) => (
              <article
                key={service.title}
                className="group w-full bg-white p-7 rounded-lg shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl sm:p-8"
              >
      ...
      <section className="w-full bg-white py-10 sm:py-14 lg:py-16 rounded-lg">
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-10">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            {/* RIGHT FEATURE CARD */}
            <div className="rounded-lg bg-ameltan p-7 sm:p-10">
